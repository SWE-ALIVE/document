...
\centering
\begin{minipage}{0.5\columnwidth}
    \includegraphics[width=\linewidth]{img/SoftInUse/AWS.jpg}
...
\begin{figure}[h]
\centering   
\includegraphics[width=0.9\columnwidth]{img/architecture/OverallArchitecture.png}
...
\centering
\begin{minipage}{0.8\columnwidth}
    \includegraphics[width=\linewidth]{img/AI/methodology.png}
